...
async function main() {
  ...
  checks.push(await check("CLI and VS Code integrations exist", async () => includes("bin/agenttrail-chat.js", ["/api/chat", "AGENTTRAIL_URL"]) && includes("editor/vscode-agenttrail/package.json", ["agenttrail.ask", "AgentTrail: Ask about selection"]) && includes("docs/INTEGRATIONS.md", ["CLI pipe mode", "VS Code"])));
