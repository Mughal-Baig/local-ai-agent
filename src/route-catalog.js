...
const ROUTE_CATALOG = [
  ...
  { area: "sessions", module: "server.js", routes: ["/api/sessions", "/api/replay/plan", "/api/replay/bundle", "/api/replay/bundle/import", "/api/runs/pending", "/api/runs/pending/from-receipt", "/api/receipts/resume"] },
  { area: "planner", module: "server.js + src/structured-output.js", routes: ["/api/agent/plan", "/api/chat"] },
  { area: "automation", module: "server.js", routes: ["/api/webhooks/run", "/api/webhooks/triggers", "/api/webhooks/triggers/run"] },
  { area: "tools", module: "src/permissions.js + src/tool-schemas.js + src/mcp-client.js", routes: ["/api/permissions", "/api/tools/schemas", "/api/tools/capability", "/api/mcp", "/api/mcp/client/status", "/api/mcp/client/tools", "/api/mcp/client/call"] },
  { area: "models", module: "server.js", routes: ["/api/models", "/api/models/pull", "/api/models/delete", "/api/models/vision-capability"] },
  { area: "accounting-routing", module: "server.js + src/accounting-routing.js", routes: ["/api/accounting/usage", "/api/accounting/routing"] },
  ...
  { area: "system", module: "server.js + src/resilience.js + src/config-admin.js", routes: ["/api/health", "/api/resilience", "/api/resources", "/api/runtime", "/api/concurrency", "/api/config", "/api/config/admin", "/api/config/workspace", "/api/onboarding", "/api/updates/check"] },
  { area: "openai-compatible-api", module: "server.js", routes: ["/v1/chat/completions", "/v1/models", "/v1/embeddings", "/v1/openapi.json", "/api/interop/openai-export"] },
  ...
  { area: "marketplace", module: "server.js + marketplace/*.json", routes: ["/api/marketplace", "/api/marketplace/import-url", "/api/marketplace/share", "/api/marketplace/import-share"] },
  { area: "plugins", module: "src/plugin-loader.js + src/plugin-sandbox.js", routes: ["/api/plugins", "/api/plugins/status", "/api/plugins/reload", "/api/plugins/run", "/api/plugins/marketplace", "/api/plugins/install"] },
