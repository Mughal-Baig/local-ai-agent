...
const ROUTE_CATALOG = [
  ...
  { area: "memory", module: "server.js", routes: ["/api/memory", "/api/memory/structured", "/api/memory/retrieve", "/api/memory/suggestions", "/api/memory/suggestions/apply", "/api/memory/citations"] },
