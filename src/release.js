...
const RELEASE_ARTIFACTS = [
  ...
  "scripts/eval-agent-tasks.js",
  "scripts/benchmark-agent-models.js",
  ...
  "editor/vscode-agenttrail/package.json",
  "editor/vscode-agenttrail/extension.js",
  "editor/vscode-agenttrail/README.md",
  "updates/latest.json",
  ...
  "docs/quality/agent-eval-report.json",
  "docs/quality/agent-eval-trend.json",
  "docs/quality/agent-model-benchmark.json",
  ...
  "tests/unit/config-admin.test.js",
  ...
  "tests/unit/eval-quality.test.js",
  "tests/integration/eval-quality.test.js",
  "tests/unit/accounting-routing.test.js",
  "tests/integration/accounting-routing.test.js",
