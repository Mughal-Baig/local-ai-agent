...
- Native tool calling for Ollama `/api/chat` and OpenAI-compatible local backends, with per-model capability probing, schema validation, and repair for malformed arguments
