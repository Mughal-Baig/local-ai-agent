...
- Attachment picker that copies local files into `workspace/attachments/`, extracts selectable PDF/DOCX/PPTX/XLSX text into context notes, and selects them for agent context
...
- Document text extraction: `/api/documents/extract` and automatic PDF/DOCX/PPTX/XLSX attachment notes for searchable context
