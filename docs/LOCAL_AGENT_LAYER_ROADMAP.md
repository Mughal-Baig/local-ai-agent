...
- T244/T246/T247: move into Epic AJ resilience now that Epic AI privacy controls are complete.
...
Next code target: T244 graceful model-backend degradation, then T246/T247 retry and startup validation. After resilience feels complete, prioritize T281/T288/T295 so the project has a 60-second proof loop, a low-friction install, and a guided first run.
