...
- T252/T253: move into Epic AK config/admin now that Epic AJ resilience is complete.
...
Next code target: T251 request timeout/cancellation surfacing, then Epic AK settings/admin. After reliability operations feel complete, prioritize T281/T288/T295 so the project has a 60-second proof loop, a low-friction install, and a guided first run.
