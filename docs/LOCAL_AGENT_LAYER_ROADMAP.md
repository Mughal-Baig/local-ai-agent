...
- T239-T243: move into Epic AI privacy controls now that Epic AH portability is complete.
...
Next code target: T239 one-click wipe all local data, then T241/T242 retention and storage visibility. After privacy controls feel complete, prioritize T281/T288/T295 so the project has a 60-second proof loop, a low-friction install, and a guided first run.
