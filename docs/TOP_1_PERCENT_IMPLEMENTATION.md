...
| Document ingestion | `/api/documents/extract`, `/api/documents/ingest-url` with explicit allowlists, automatic PDF/DOCX/PPTX/XLSX/HTML/Markdown/code attachment text notes, progress steps, ingestion receipts, searchable extracted Markdown context |
