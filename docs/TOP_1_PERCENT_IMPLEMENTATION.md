...
| Vision input | Selected local PNG/JPEG/TIFF/BMP/WebP files flow into Ollama vision models or OpenAI-compatible local servers as image payloads, with path/hash metadata in the prompt |
